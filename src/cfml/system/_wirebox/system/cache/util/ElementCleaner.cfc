...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" output="false" returntype="ElementCleaner" hint="Constructor">
		<cfargument name="cacheProvider" type="any" required="true" hint="The associated cache manager/provider of type: wirebox.system.cache.ICacheProvider" doc_generic="wirebox.system.cache.ICacheProvider"/>
		<cfscript>
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="getAssociatedCache" access="public" output="false" returntype="any" hint="Get the associated cache provider/manager of type: wirebox.system.cache.ICacheProvider" doc_generic="wirebox.system.cache.ICacheProvider">
