...
component accessors="true" singleton {
	 ...
	 *
	 * @return The ColdBox Schedule class to work with the schedule: wirebox.system.async.tasks.Executor
	 */
	 ...
	 * @return The executor object: wirebox.system.async.tasks.Executor
	 */
