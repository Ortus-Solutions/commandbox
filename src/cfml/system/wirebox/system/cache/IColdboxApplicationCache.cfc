...
<cfinterface extends="wirebox.system.cache.ICacheProvider" hint="DEPRECATED: USE wirebox.system.cache.providers.IColdBoxProvider instead.">
	...
	<!--- getColdbox --->
    <cffunction name="getColdbox" output="false" access="public" returntype="any" hint="Get the coldbox application reference as wirebox.system.web.Controller">
    </cffunction>

	<!--- setColdbox --->
    <cffunction name="setColdbox" output="false" access="public" returntype="void" hint="Set the coldbox application reference">
    	<cfargument name="coldbox" type="any" required="true" hint="The coldbox application reference as type: wirebox.system.web.Controller"/>
    </cffunction>
