...
component
	...
	extends="wirebox.system.cache.providers.CacheBoxProvider"
{
	...
	function init(){
		...
		// URL Facade Utility
		variables.eventURLFacade = new wirebox.system.cache.util.EventURLFacade( this );
	 ...
	 *
	 * @return wirebox.system.web.Controller
	 */
	function getColdbox(){
	 ...
	 *
	 * @return wirebox.system.cache.util.EventURLFacade
	 */
