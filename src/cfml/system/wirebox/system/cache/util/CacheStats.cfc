 ...
 */
component implements="wirebox.system.cache.util.IStats" accessors="true"{

	/**
	 * The associated cache manager/provider of type: wirebox.system.cache.providers.ICacheProvider
	 */
	 ...
	 * Constructor
	 *
	 * @cacheProvider The associated cache manager/provider of type: wirebox.system.cache.providers.ICacheProvider
	...
	/**
	 * Get the associated cache provider/manager of type: wirebox.system.cache.providers.ICacheProvider
	 *
