...
These tutorials on Java Streams are fantastic. We encourage you to read them to see the power of streams. You can also find the `cbstreams` API Docs to be a great source of information: [https://apidocs.ortussolutions.com/#/coldbox-modules/cbstreams](https://apidocs.ortussolutions.com/#/coldbox-modules/cbstreams)
