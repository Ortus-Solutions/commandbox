...
volume="commandbox-cli-bootstrap-alpine-$RANDOM"
...
docker run --rm \
	...
	alpine:3.20 sh -s <<'CONTAINER_SCRIPT'
set -eu
echo "[alpine] Installing Java..."
