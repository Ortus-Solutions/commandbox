# CommandBox Contributing Guide

Hola amigo! I'm really excited that you are interested in contributing to CommandBox. Before submitting your contribution, please make sure to take a moment and read through the following guidelines:
...
Bug reports for CommandBox should be submitted to our Jira issue tracker. Please make sure also that if you submit a pull request, you link it to the appropriate issue.

- CommandBox : https://ortussolutions.atlassian.net/browse/COMMANDBOX
...
- Ortus Community Discourse: https://community.ortussolutions.com/c/communities/commandbox/14
...
We have added all the necessary information for you to develop on CommandBox in our [readme](readme.md) and also in our [tests readme](tests/readme.md) if you need to run tests.
...
You can support CommandBox and all of our Open Source initiatives at Ortus Solutions by becoming a patreon.  You can also get lots of goodies and services depending on the level of contributions.
...
Thank you to all the people who have already contributed to CommandBox! We :heart: :heart: :heart: love you!

<a href = "https://github.com/Ortus-Solutions/commandbox/graphs/contributors">
  <img src = "https://contrib.rocks/image?repo=Ortus-Solutions/commandbox" alt="CommandBox Contributors"/>
</a>
